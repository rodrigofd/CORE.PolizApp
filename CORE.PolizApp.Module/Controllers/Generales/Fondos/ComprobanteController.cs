...
using Comprobante = CORE.Modulos.Gestion.Comprobante;

namespace CORE.Modulos.Controllers.Fondos
{
  public class ComprobanteController : ComprobanteBaseController
  {
    ...
    protected override void CreateActions( )
    {
      ...
      ComprobanteExportReportAction.Id = "FondosComprobanteExportReportAction";
      ComprobanteConfirmarAction.Id = "FondosComprobanteConfirmarAction";
      ComprobanteDuplicarAction.Id = "FondosComprobanteDuplicarAction";
      ...
      reversarAction.Id = "FondosReversarComprobante";
