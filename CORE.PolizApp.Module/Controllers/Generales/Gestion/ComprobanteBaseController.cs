...
using CORE.Modulos.Modelo.Sistema;

namespace CORE.Modulos.Controllers.Gestion
{
  ...
  public abstract class ComprobanteBaseController : ViewController
  {
    ...
    public ComprobanteBaseController( )
    {
      InitializeComponent( );
    }
    ...
    protected virtual void CreateActions( )
    {
      ...
      // exportReportAction
      // 
      ComprobanteExportReportAction = new SingleChoiceAction( this, "ComprobanteExportReportAction", PredefinedCategory.Reports );
      ...
      ComprobanteConfirmarAction.Id = "ComprobanteConfirmarAction";
      ...
      ComprobanteDuplicarAction.Id = "ComprobanteDuplicarAction";
