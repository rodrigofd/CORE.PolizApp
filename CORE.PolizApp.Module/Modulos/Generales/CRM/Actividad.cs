...
namespace CORE.Modulos.CRM
{
  ...
  {
    [ ImageName( "inbox-download" ) ]
    Entrada = 1,

    [ ImageName( "inbox-upload" ) ]
    Salida,
  }
  ...
  public class Actividad : BasicObject, IObjetoPorGrupo
  {
    ...
    [ ImmediatePostData ]
    [ RuleValueComparison( "inicio_fin", DefaultContexts.Save, ValueComparisonType.GreaterThanOrEqual, "Inicio", ParametersMode.Expression ) ]
    ...
    [ Appearance( "act_mostrar_cc", AppearanceItemType.ViewItem, "IsNull(Tipo) or Tipo.UsaCC = false", Visibility = ViewItemVisibility.Hide ) ]
    ...
    [ Appearance( "act_mostrar_bcc", AppearanceItemType.ViewItem, "IsNull(Tipo) or Tipo.UsaBCC = false", Visibility = ViewItemVisibility.Hide ) ]
    ...
    public XPCollection< ActividadResponsable > Responsables
    {
      get { return GetCollection< ActividadResponsable >( "Responsables" ); }
    }
    ...
    public override void AfterConstruction( )
    {
      ...
      Responsables.Add( new ActividadResponsable( Session ) { Responsable = CoreAppLogonParameters.Instance.UsuarioActual( Session ), Principal = true } );
    }
  }
}
