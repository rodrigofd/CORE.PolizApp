...
namespace CORE.Modulos.Gestion
{
  ...
  [ RuleCriteria( "CORE.Modulos.Gestion.Comprobante.ItemsConCuotas",
...
public class Comprobante : ComprobanteBase
  {
    ...
    internal virtual void CopiarDatosPersona( Persona persona )
    {
      ...
      if( Tipo != null )
      {
        ...
        foreach( var impuesto in persona.DatosImpositivos.Where( impuesto => impuesto.Categoria.Impuesto.Oid == ( int ) CORE.Modulos.Impuestos.Impuestos.IVA ) )
        {
